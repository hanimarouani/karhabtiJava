 ...
 * @author HANY
 */
public class ResultatDuTest3Controller implements Initializable {
@FXML
    ...
    void imprimerRes(ActionEvent event) throws IOException {
        GeneratePDF pdf;
        String ReponsesCorretes = "Nombre de réponses Correctes = "+Niveau3Controller.repSuccniv3;
        String ReponsesFausses = "Nombre de réponses fausses = "+Niveau3Controller.repEchniv3;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        repCorrecte.setText("Nombre de réponses Correctes = "+Niveau3Controller.repSuccniv3);
        repFausses.setText("Nombre de réponses fausses = "+Niveau3Controller.repEchniv3);
    } 
}
