 ...
 * @author HANY
 */
public class StatisticNiv1Controller implements Initializable {
@FXML
...
public final ObservableList<PieChart.Data> detatils = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         int repCorrectes= reponse.nombreTestsSucces(1).getReponseSucces();
         int repFausses =reponse.nombreTestsSucces(1).getReponseEchec();
