 ...
 * @author HANY
 */
public class ResultatDuTest5Controller implements Initializable {
@FXML
    ...
    void imprimerRes(ActionEvent event) throws IOException {
        GeneratePDF pdf;
        String ReponsesCorretes = "Nombre de réponses Correctes = "+Niveau5Controller.repSuccniv5;
        String ReponsesFausses = "Nombre de réponses fausses = "+Niveau5Controller.repEchniv5;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        repCorrecte.setText("Nombre de réponses Correctes = "+Niveau5Controller.repSuccniv5);
        repFausses.setText("Nombre de réponses fausses = "+Niveau5Controller.repEchniv5);
    } 
}
