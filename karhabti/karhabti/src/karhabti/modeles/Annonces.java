...
public class Annonces {
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Objects.hashCode(this.BOITE);
        hash = 79 * hash + Objects.hashCode(this.region);
        hash = 79 * hash + this.NOMBRE_DE_CYLINDRES;
        hash = 79 * hash + Objects.hashCode(this.ENERGIE);
        hash = 79 * hash + Objects.hashCode(this.DESCRIPITION);
        hash = 79 * hash + this.validation;
        hash = 79 * hash + Float.floatToIntBits(this.PRIX);
        hash = 79 * hash + Float.floatToIntBits(this.PUISSANCE_FISCALE);
        hash = 79 * hash + Float.floatToIntBits(this.CYLINDREE);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.NOMBRE_DE_CYLINDRES != other.NOMBRE_DE_CYLINDRES) {
            return false;
        }
        if (this.validation != other.validation) {
            return false;
        }
        if (Float.floatToIntBits(this.PRIX) != Float.floatToIntBits(other.PRIX)) {
            return false;
        }
        if (Float.floatToIntBits(this.PUISSANCE_FISCALE) != Float.floatToIntBits(other.PUISSANCE_FISCALE)) {
            return false;
        }
        if (Float.floatToIntBits(this.CYLINDREE) != Float.floatToIntBits(other.CYLINDREE)) {
            return false;
        }
        if (!Objects.equals(this.TITRE, other.TITRE)) {
            return false;
        }
        if (!Objects.equals(this.BOITE, other.BOITE)) {
            return false;
        }
