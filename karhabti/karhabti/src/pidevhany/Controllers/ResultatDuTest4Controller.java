 ...
 * @author HANY
 */
public class ResultatDuTest4Controller implements Initializable {
@FXML
    ...
    void imprimerRes(ActionEvent event) throws IOException {
        GeneratePDF pdf;
        String ReponsesCorretes = "Nombre de réponses Correctes = "+Niveau4Controller.repSuccniv4;
        String ReponsesFausses = "Nombre de réponses fausses = "+Niveau4Controller.repEchniv4;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        repCorrecte.setText("Nombre de réponses Correctes = "+Niveau4Controller.repSuccniv4);
        repFausses.setText("Nombre de réponses fausses = "+Niveau4Controller.repEchniv4);
    } 
}
