 ...
 * @author HANY
 */
public class ResultatDuTest1Controller implements Initializable {
  @FXML
    ...
    void imprimerRes(ActionEvent event) throws IOException {
        GeneratePDF pdf;
        String ReponsesCorretes = "Nombre de réponses Correctes = "+Niveau1Controller.repSuccniv1;
        String ReponsesFausses = "Nombre de réponses fausses = "+Niveau1Controller.repEchniv1;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        repCorrecte.setText("Nombre de réponses Correctes = "+Niveau1Controller.repSuccniv1);
        repFausses.setText("Nombre de réponses fausses = "+Niveau1Controller.repEchniv1);
    }    
