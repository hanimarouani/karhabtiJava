 ...
 * @author HANY
 */
public class ResultatDuTest2Controller implements Initializable {
@FXML
    ...
    void imprimerRes(ActionEvent event) throws IOException {
        GeneratePDF pdf;
        String ReponsesCorretes = "Nombre de réponses Correctes = "+Niveau2Controller.repSuccniv2;
        String ReponsesFausses = "Nombre de réponses fausses = "+Niveau2Controller.repEchniv2;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        repCorrecte.setText("Nombre de réponses Correctes = "+Niveau2Controller.repSuccniv2);
        repFausses.setText("Nombre de réponses fausses = "+Niveau2Controller.repEchniv2);
    } 
