 ...
 * @author Mohamed
 */
public class RateController extends Application implements Initializable {
    ...
    void rate(MouseEvent event) throws IOException {
        ...
        Parent creerGroupe = FXMLLoader.load(getClass().getResource("/Gui/Rate.fxml"));
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Gui/Rate.fxml"));
