 ...
 * @author HANY
 */
public class StatisticNiv6Controller implements Initializable {
@FXML
...
public final ObservableList<PieChart.Data> detatils = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         int repCorrectes= reponse.nombreTestsSucces(3).getReponseSucces();
         int repFausses =reponse.nombreTestsSucces(3).getReponseEchec();
